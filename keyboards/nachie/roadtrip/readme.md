...
Firmware for the RoadTrip

* Keyboard Maintainer: [Nachie](https://github.com/nachie)
* Hardware Supported: RoadTrip
* Hardware Availability: [Little Craftery](https://littlecraftery.com/products/roadtrip)

Make example for this keyboard (after setting up your build environment):

    make nachie/roadtrip:default

Or to make and flash:

    make nachie/roadtrip:default:flash
