...
Firmware for the Parity

* Keyboard Maintainer: [Nachie](https://github.com/nachie)
* Hardware Supported: Parity
* Hardware Availability: [Little Craftery](https://littlecraftery.com/products/parity)

Make example for this keyboard (after setting up your build environment):

    make nachie/parity:default

Or to make and flash:

    make nachie/parity:default:flash
