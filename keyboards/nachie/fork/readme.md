...
Firmware for the Fork PCB

* Keyboard Maintainer: [Nachie](https://github.com/nachie)
* Hardware Supported: Fork
* Hardware Availability: [Little Craftery](https://littlecraftery.com/products/fork)

Make example for this keyboard (after setting up your build environment):

    make nachie/fork:default

Or to make and flash:

    make nachie/fork:default:flash
